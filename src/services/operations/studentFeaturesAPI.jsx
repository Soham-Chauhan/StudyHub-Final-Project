...
export const buyCourse = async (token, courses, userDetails, navigate, dispatch,)=> {
    console.log("COURSES IN buyCourse:", courses);
    ...
    try {
        ...
        const razorpayKey = process.env.REACT_APP_RAZORPAY_KEY || "rzp_test_SVUJRfhus5WDHk";
        if (!razorpayKey) {
            toast.error("RazorPay Key is missing from environment variables");
            return;
        }
