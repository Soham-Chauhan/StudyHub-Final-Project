...
const professions = ["Developer", "Designer", "Student", "Teacher", "Other"]
        ...
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-5 form-style">
                {["Male", "Female", "Other"].map((gender) => (
                  <div key={gender} className="flex items-center gap-2">
                    <input
                      ...
                      defaultChecked={user?.additionalDetails?.gender === gender}
                      className="accent-yellow-100"
                    />
                    <label htmlFor={gender} className="text-richblack-5 cursor-pointer">
                      {gender}
                    </label>
                  </div>
                ))}
